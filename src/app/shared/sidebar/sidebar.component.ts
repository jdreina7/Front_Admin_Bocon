...
import { ROUTES_ADMIN } from './sidebar-routes-super.config';
import { ROUTES_NORMAL } from './sidebar-routes-normal.config';
...
export class SidebarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    // CONDICIONO EL MENU PARA SABER CUAL CARGAR DEPENDIENDO DEL ROLE DEL USUARIO
    if ( this.usuario.usr_role === 'ROLE_SUPER') {
      this.menuItems = ROUTES_ADMIN;
    } else {
      this.menuItems = ROUTES_NORMAL;
    }
